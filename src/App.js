  ...
  return (
    <div className="app">
      ...
      <div className="app__stats">
         <InfoBox isRed active={casesType ==="cases"} onClick={e => setCasesType('cases')} title="Corona Virus" cases={prettyPrintStat(countryInfo.todayCases)} total={countryInfo.cases}/>
